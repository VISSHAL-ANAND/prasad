...
export default function Hero(){
 ...
 return <section onMouseMove={move} className="relative min-h-screen overflow-hidden bg-[#171717] text-[#f2f2f0]">
  <motion.div style={{x:sx,y:sy,scale:1.045}} className="absolute inset-[-2%] bg-cover bg-center" initial={{scale:1.08}} animate={{scale:1.045}} transition={{duration:1.4,ease:[.16,1,.3,1]}} />
  <div className="absolute inset-0 bg-black/45"/>
  <div className="absolute inset-0 bg-gradient-to-b from-black/25 via-black/10 to-[#171717]"/>
  <div className="absolute left-0 right-0 top-[105px] overflow-hidden md:top-[112px]">
   <motion.div whileHover={{x:"-2%"}} transition={{duration:.8,ease:[.16,1,.3,1]}} className="display select-none whitespace-nowrap text-center text-[26vw] font-black uppercase leading-[.68] tracking-[-.12em] text-[#f0f0ee] md:text-[21vw]">CONVOY</motion.div>
  </div>
  <div className="container relative z-10 flex min-h-screen flex-col justify-end pb-10 pt-32 md:pb-12">
   ...
   <div className="mx-auto max-w-[850px] text-center">
    <motion.h1 initial={{y:35,opacity:0}} animate={{y:0,opacity:1}} transition={{duration:.8,delay:.15,ease:[.16,1,.3,1]}} className="display text-[11vw] font-semibold leading-[.92] md:text-[5.8rem]">Move Freight Smarter,<br/>Grow Business Faster</motion.h1>
