...
export default function Hero(){
 ...
 return <section onMouseMove={move} className="relative min-h-screen overflow-hidden bg-[#171717] text-[#f2f2f0]">
  <motion.div style={{x:sx,y:sy,scale:1.045,backgroundImage:"url(https://images.unsplash.com/photo-1494412651409-8963ce7935a7?auto=format&fit=crop&w=2400&q=90)"}} className="absolute inset-[-2%] bg-cover bg-center" initial={{scale:1.08}} animate={{scale:1.045}} transition={{duration:1.4,ease:[.16,1,.3,1]}} />
  ...
  <div className="absolute left-0 right-0 top-[108px] overflow-hidden md:top-[116px]"><motion.div whileHover={{x:"-2%"}} transition={{duration:.8,ease:[.16,1,.3,1]}} className="display select-none whitespace-nowrap text-center text-[26vw] font-black uppercase leading-[.68] tracking-[-.12em] text-[#f0f0ee] md:text-[21vw]">CONVOY</motion.div></div>
